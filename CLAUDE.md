...
A knowledge base of <!-- kb:counts -->216 software design patterns, 40 design case studies, 42 themes, 36 hazards, 27 principles, 10 cloud capabilities and 10 product comparisons — 381 pages in all<!-- /kb:counts -->.
...
<!-- kb:page-tokens -->~7k<!-- /kb:page-tokens --> for one raw page. `find` searches the full prose of all <!-- kb:page-count -->381<!-- /kb:page-count --> pages — that costs
