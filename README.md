...
A cross-linked reference of **<!-- kb:counts -->209 software design patterns, 40 design case studies, 39 themes, 36 hazards, 27 principles, 10 cloud capabilities and 10 product comparisons — 371 pages in all<!-- /kb:counts -->**, written to be
...
`scripts/kb.mjs` searches the full prose of all <!-- kb:page-count -->371<!-- /kb:page-count --> pages and returns clean text, so you
