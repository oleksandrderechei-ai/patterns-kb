...
A cross-linked reference of **<!-- kb:counts -->170 software design patterns, 40 design case studies, 25 themes, 14 hazards and 11 principles — 260 pages in all<!-- /kb:counts -->**, written to be
...
`find` searches the full prose of all <!-- kb:page-count -->260<!-- /kb:page-count --> pages and prints the line that matched. It weights
