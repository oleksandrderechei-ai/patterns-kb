...
**Anti-patterns** — 36 of them. Not to practise, only to recognise on sight.
Every one is what the patterns elsewhere exist to prevent.

Pages here: anemic-domain-model, big-ball-of-mud, boat-anchor, busy-database, busy-front-end, cache-stampede, cascading-failure, chatty-io, connection-pool-exhaustion, deadlock, distributed-monolith, dual-write-inconsistency, extraneous-fetching, god-object, golden-hammer, host-header-rewriting, hot-key, hot-partition, improper-instantiation, leaky-abstraction, monolithic-persistence, n-plus-1-query, no-caching, noisy-neighbour, partial-object, race-condition, resource-leak, retry-storm, spaghetti-code, split-brain, stale-cache, starvation, static-cling, synchronous-io, thundering-herd, unbounded-queue
